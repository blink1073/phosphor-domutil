...
var DRAG_MIME_TYPE = 'application/x-phosphor-draggable';
var dropCache = {
 ...
 */
function getDropData(event, mime) {
    var id = event.dataTransfer.getData(DRAG_MIME_TYPE) || -1;
    return dropCache.data[id] && dropCache.data[id][mime];
}
exports.getDropData = getDropData;
/**
 ...
 */
function clearDropData(event) {
    var id = event.dataTransfer.getData(DRAG_MIME_TYPE);
    delete dropCache.data[id];
}
exports.clearDropData = clearDropData;
