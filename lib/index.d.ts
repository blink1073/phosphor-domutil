 ...
 */
export declare function getDropData(event: DragEvent, mime: string): any;
/**
 * Set arbitrary data associated with a specific drag event.
 *
 * Should be called in a dragstart event handler.
 */
export declare function setDropData(event: DragEvent, mime: string, data: any): void;
/**
 * Clear data being held privately for a specific drag event.
 *
 * Should be called in a dragend event handler.
 */
export declare function clearDropData(event: DragEvent): void;
